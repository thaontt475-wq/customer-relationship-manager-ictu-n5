...
<body class="crm-body">
    ...
    <script>
        (function() {
            ...
            // Bộ nhớ đệm lưu trạng thái ban đầu của người dùng đang chọn để có thể "Đặt lại"
            ...
            function showSuccess(message) {
                clearAlerts();
                clientSuccessText.textContent = message || 'Cập nhật phân quyền thành công!';
            ...
            function applyUserPermissionsToForm(data) {
                ...
                if (data.team) {
                    ...
                    if (teamName) userTeamDisplay.textContent = teamName;
                }
            ...
            function loadUserPermissions(userId) {
                ...
                .then(function(resData) {
                    // Xử lý dữ liệu trả về theo contract hoặc bọc trong data
            ...
            function savePermissions() {
                ...
                .catch(function(err) {
                    // Tuyệt đối không giả lập thành công khi có lỗi xảy ra
